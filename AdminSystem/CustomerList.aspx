...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnReturnToMainMenu" runat="server" OnClick="btnReturnToMainMenu_Click" style="z-index: 1; left: 309px; top: 516px; position: absolute; width: 139px; height: 28px; bottom: 121px" Text="Return To Main Menu" />
        <br />
