...
<body style="height: 370px">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnReturnToMainMenu" runat="server" style="z-index: 1; left: 177px; top: 342px; position: absolute; height: 24px; width: 150px" Text="Return To Main Menu" />
    </form>
</body>
</html>
