...
<body style="height: 404px">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnStock" runat="server" style="z-index: 1; left: 24px; top: 96px; position: absolute; right: 449px" Text="Stock" Width="50px" />
        <asp:Button ID="btnCustomers" runat="server" style="z-index: 1; left: 165px; top: 96px; position: absolute" Text="Customers" />
