...
<body>
   ...
   <form id="form1" runat="server">
        <div style="height: 178px">
            ...
            <asp:Label ID="lblOrderId" runat="server" style="z-index: 1; left: 10px; top: 38px; position: absolute; height: 19px" Text="OrderId"></asp:Label>
            <asp:Label ID="lblStockId" runat="server" style="z-index: 1; left: 10px; top: 68px; position: absolute" Text="StockId"></asp:Label>
            <asp:Label ID="lblQuantity" runat="server" style="z-index: 1; left: 10px; top: 103px; position: absolute" Text="Quantity"></asp:Label>
            ...
            <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 274px; top: 16px; position: absolute" Text="Find" />
        </div>
