...
namespace ClassLibrary
{
    ...
    {
        //private data memebr for the user id property
        private Int32 mUserID;
        //private data memebr for the user name property
        private string mUserName;
        //private data memebr for the password property
        private string mPassword;
        //private data memebr for the department property
